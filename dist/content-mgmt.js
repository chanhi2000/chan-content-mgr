...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  switch (message.type) {
    ...
    case 'FETCH_C_SHARPCORNER_BLOG':      sendResponse({ status: "fetch c-sharpcorner Blog DONE!", o: fetchCSharpcornerBlog() });break;
    ...
    case 'FETCH_MASTER_DEV_BLOG':         sendResponse({ status: "fetch Master Dev Blog DONE!", o: fetchMasterDevBlog(message.path) });break;
    ...
    case 'FETCH_THEO_SOTI_BLOG':          sendResponse({ status: "fetch CSS Tips by Theo Soti Blog DONE!", o: fetchTheoSotiBlog(message.path) });break;  
    case 'FETCH_JOSH_TUMATH_BLOG':        sendResponse({ status: "fetch Josh Tumath Blog DONE!", o: fetchJoshTumathBlog(message.path) });break;  
